    ...
    private Map<String, String> getSearchResults(String searchMask) {
        ...
        if (!studentsMatchingPhone.isEmpty()) {
            ...
            for (Student student : studentsMatchingPhone) {
                ...
                String coursePrice = ua.kiev.prog.Config.PriceSource.getPriceByCourse(studentCourse);
                String link = ua.kiev.prog.Config.LinkSource.getLinkByCourse(studentCourse);
