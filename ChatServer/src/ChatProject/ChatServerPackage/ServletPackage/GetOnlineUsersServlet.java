...
import ChatProject.ChatServerPackage.ServletPackage.JSONDataStructures.UserJSON;
import ChatProject.ChatServerPackage.ServletPackage.JSONDataStructures.UsersJSON;
...
public class GetOnlineUsersServlet extends HttpServlet {
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        {
            for (User user : room.getMembers().values())
            {
